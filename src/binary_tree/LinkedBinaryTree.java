...
import exceptions.*;
import list.book_list_implementations.*;
...
public class LinkedBinaryTree<T> implements BinaryTreeADT<T>, Iterable<T>
{
     ...
     *
     * @param root_node the node that will become the root of the binary tree
     */
    public LinkedBinaryTree(BinaryTreeNode<T> root_node)
    {
        root = root_node;
    }
    ...
    public int size() 
    {
        ...
        else return 1+ root.numChildren();
        // To be completed as a Programming Project
    }
    ...
    private int height(BinaryTreeNode<T> node) 
    {
        ...
        int leftTHeight = height(node.getLeft());
        int rightTHeight = height(node.getRight());
