...
//     */
    ...
    public T findMin() throws EmptyCollectionException 
    {
        ...
        // keep traversing nodes until no further left child
    ...
    {
        BinaryTreeNode<T> current_node = root;
        // keep traversing nodes until no further right child
        while(current_node.getRight()!= null) {
    ...
    private BinaryTreeNode<T> findNode(T targetElement, BinaryTreeNode<T> next) 
    {
        ...
        if (comparableElement.equals(next.getElement())) return next;
